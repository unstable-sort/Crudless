...
namespace UnstableSort.Crudless.Tests
{
    ...
    public class FilterTests : BaseUnitTest
    {
        ...
        public async Task Handle_IncludeBeforeConstantDate_FiltersEntities()
        {
            ...
            Assert.AreEqual(Date.AddDays(-4), response.Result.Items[0].CreatedDate);
            Assert.AreEqual(Date.AddDays(-2), response.Result.Items[1].CreatedDate);
            Assert.AreEqual(Date, response.Result.Items[2].CreatedDate);
        }
        ...
        public async Task Handle_ExcludeBeforeConstantDate_FiltersEntities()
        {
            ...
            Assert.NotNull(response.Result.Items);
            Assert.AreEqual(2, response.Result.Items.Count);
            Assert.AreEqual(Date.AddDays(2), response.Result.Items[0].CreatedDate);
            Assert.AreEqual(Date.AddDays(4), response.Result.Items[1].CreatedDate);
        }
        ...
        public async Task Handle_ExcludeBeforeRequestDate_FiltersEntities()
        {
            ...
            Assert.NotNull(response.Result.Items);
            Assert.AreEqual(3, response.Result.Items.Count);
            Assert.AreEqual(Date, response.Result.Items[0].CreatedDate);
            Assert.AreEqual(Date.AddDays(2), response.Result.Items[1].CreatedDate);
            Assert.AreEqual(Date.AddDays(4), response.Result.Items[2].CreatedDate);
        }
        ...
        public async Task Handle_IncludeWithinConstantAndConstantDate_FiltersEntities()
        {
            ...
            Assert.AreEqual(3, response.Result.Items.Count);
            Assert.AreEqual(Date.AddDays(-2), response.Result.Items[0].CreatedDate);
            Assert.AreEqual(Date, response.Result.Items[1].CreatedDate);
            Assert.AreEqual(Date.AddDays(2), response.Result.Items[2].CreatedDate);
        }
        ...
        public async Task Handle_IncludeStartsWithConstantString_FiltersEntities()
        {
            ...
            Assert.NotNull(response.Result.Items);
            Assert.AreEqual(2, response.Result.Items.Count);
            Assert.AreEqual("BADSite1", response.Result.Items[0].Name);
            Assert.AreEqual("BADSite2", response.Result.Items[1].Name);
        }
